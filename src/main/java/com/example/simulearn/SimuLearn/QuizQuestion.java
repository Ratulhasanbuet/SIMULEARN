...
public class QuizQuestion {
    ...
    public QuizQuestion(int questionNum, String questionText, String[] options,
        ...
        if (!isFeedback) {
            ...
            attemptsLabel.setFont(Font.font("DM Sans Medium", FontWeight.BOLD, 14));
            attemptsLabel.setStyle("-fx-text-fill: #333333;");
        }

        submitButton = new Button("Submit answer");
        submitButton.setFont(Font.font("DM Sans Medium", FontWeight.BOLD, 14));
    ...
    private HBox createOptionBox(String optionText, char letter, int index) {
        ...
        letterLabel.setFont(Font.font("DM Sans Medium", FontWeight.BOLD, 16));
    ...
    private void showFeedback(int selectedIndex, boolean correct) {
        ...
        if (correct) {
            ...
            checkmark.setFont(Font.font("DM Sans Medium", FontWeight.BOLD, 18));
            ...
            xMark.setFont(Font.font("DM Sans Medium", FontWeight.BOLD, 18));
