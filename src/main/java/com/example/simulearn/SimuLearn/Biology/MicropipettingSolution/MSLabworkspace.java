...
public class MSLabworkspace {
    ...
    private void showToast(String message, String type, int seconds) {
        ...
        slideIn.setFromY(-80);
        slideIn.setToY(80); // land 80px from top
        ...
        // Play slide in, then start countdown
    ...
    private class DraggableTube {
        ...
        private void toggleTube() {
            ...
            view.getChildren().set(1, newTubeImage);  // index 1 = tubeImage (label is at index 0)
...
//
//        private void createView() {
//            // Use Pane so Labels position correctly inside Group
//            javafx.scene.layout.Pane paperPane = new javafx.scene.layout.Pane();
//            paperPane.setPrefSize(400, 210);
//
//            // White paper background
//            Rectangle paper = new Rectangle(400, 210);
//            paper.setFill(Color.WHITE);
//            paper.setStroke(Color.web("#b0c4cc"));
//            paper.setStrokeWidth(1.5);
//            paper.setArcWidth(12);
//            paper.setArcHeight(12);
//            DropShadow shadow = new DropShadow();
...
//            // Title label
//            Label titleLabel = new Label("Blotting Paper");
//            titleLabel.setFont(Font.font("DM Sans Medium", FontWeight.BOLD, 13));
//            titleLabel.setTextFill(Color.web("#0c2d3a"));
//            titleLabel.setLayoutX(145);
//            titleLabel.setLayoutY(8);
//            paperPane.getChildren().add(titleLabel);
//
//            // Create 4 circles
//            String[] labels = {"A", "B", "C", "D"};
//            for (int i = 0; i < 4; i++) {
//                double circleX = 50 + (i * 90);
//                double circleY = 100;
//                createCircleSpot(labels[i], circleX, circleY, paperPane);
//            }
//
//            paperGroup = new Group(paperPane);
//            paperGroup.setLayoutX(x);
//            paperGroup.setLayoutY(y);
//        }
//
...
//            Circle outerCircle = new Circle(circleX, circleY, 35);
//            outerCircle.setFill(Color.TRANSPARENT);
//            outerCircle.setStroke(Color.web("#0c2d3a"));
//            outerCircle.setStrokeWidth(2);
//
//            // Inner red circle (grows with volume)
//            Circle redCircle = new Circle(circleX, circleY, 0);
//            redCircle.setFill(Color.web("#e63946"));
//            redCircles.put(label, redCircle);
//
//            // Circle label (A/B/C/D) — below circle
//            Label circleLabel = new Label(label);
//            circleLabel.setFont(Font.font("DM Sans Medium", FontWeight.BOLD, 14));
//            circleLabel.setTextFill(Color.web("#0c2d3a"));
//            circleLabel.setLayoutX(circleX - 6);
//            circleLabel.setLayoutY(circleY + 40);
//
//            // Volume label — below letter
//            Label volumeLabel = new Label("0.0µl");
//            volumeLabel.setFont(Font.font("DM Sans Medium", FontWeight.NORMAL, 11));
//            volumeLabel.setTextFill(Color.web("#1a4a5a"));
//            volumeLabel.setLayoutX(circleX - 16);
//            volumeLabel.setLayoutY(circleY + 58);
//            volumeLabels.put(label, volumeLabel);
//
//            pane.getChildren().addAll(outerCircle, redCircle, circleLabel, volumeLabel);
//        }
//
//        public Group getView() {
//            return paperGroup;
