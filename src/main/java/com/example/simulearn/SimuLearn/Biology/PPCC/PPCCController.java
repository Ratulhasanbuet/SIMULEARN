...
// Image container
    ...
    private void resetToButtonView() {
        // কোন button টা selected ছিল সেটা track করো
        String selectedText = (selectedButton != null) ? selectedButton.getText() : null;
        selectedButton = null; // clear করো, নইলে নতুন buttons এ apply হবে না

        instruction.getChildren().clear();
        buttonPanel = createButtonPanel();
        instruction.getChildren().add(buttonPanel);

        // নতুন button panel থেকে সঠিক button টা খুঁজে select করো
