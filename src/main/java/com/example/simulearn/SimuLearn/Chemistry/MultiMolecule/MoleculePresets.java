...
public class MoleculePresets {
    ...
    private static PresetInfo co2() {
        MoleculeGraph g = new MoleculeGraph();
        MoleculeAtom C = g.addAtom("C");
        MoleculeAtom O1 = g.addAtom("O");
        O1.lonePairs = 2;
        MoleculeAtom O2 = g.addAtom("O");
        O2.lonePairs = 2;
        g.addBond(O1, C, 2);
        g.addBond(C, O2, 2);
    ...
    private static PresetInfo xef2() {
        MoleculeGraph g = new MoleculeGraph();
        MoleculeAtom Xe = g.addAtom("Xe");
        Xe.lonePairs = 3;
        MoleculeAtom F1 = g.addAtom("F");
        F1.lonePairs = 3;
        MoleculeAtom F2 = g.addAtom("F");
        F2.lonePairs = 3;
        g.addBond(Xe, F1, 1);
        g.addBond(Xe, F2, 1);
