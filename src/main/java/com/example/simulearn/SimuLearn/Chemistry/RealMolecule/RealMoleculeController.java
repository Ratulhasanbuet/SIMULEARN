...
import com.example.simulearn.SimuLearn.Chemistry.QuizQuestionDark;
...
public class RealMoleculeController implements Initializable {
    ...
    private Rotate rotateX = new Rotate(25, Rotate.X_AXIS);
    ...
    private void showLaunchMode() {
        ...
        if (subscene != null) {
            ...
            view3DContainer.setOnMouseDragged(e -> {
    ...
    private void createLaunchControlPanel() {
        ...
        resetViewBtn.setPadding(new Insets(12));
        resetViewBtn.setStyle(
                "-fx-background-color: #222244;" +
                        "-fx-text-fill: white;" +
                        "-fx-background-radius: 8;" +
                        "-fx-cursor: hand;");
        ...
        showLpCheck.setOnAction(e -> {
            showLonePairs = showLpCheck.isSelected();
            updateMolecule();
        });
        ...
        VBox.setMargin(resetViewBtn, new Insets(5, 0, 10, 0));
    ...
    private void setup3DView() {
        ...
        Group root3D = new Group(ambient, key, fill, moleculeGroup);
