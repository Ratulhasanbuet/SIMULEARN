package com.example.simulearn.SimuLearn.Chemistry;
...
public class VSEPRGeometry {
    ...
    int lonePairs;
    int bondedAtoms;
    public String bondAngles;
    Point3D[] positions;

    VSEPRGeometry(String name, String electronGeometry, int stericNumber, int lonePairs, int bondedAtoms, String bondAngles, Point3D[] positions) {
        this.name = name;
