...
public class LogicCircuitController {
    ...
    @FXML private Button addNodeButton,AndButton,orButton,notButton,nandButton,norButton,ToggleButton;
    ...
    {
        // this function draws a shape from a line
        Arc arc = new Arc();
    ...
    private void drawOrGate(NodePoint n1,NodePoint n2,boolean isNOR)
    {
        ...
        line2.setStrokeWidth(2);
        Line line3;
        //if the lines are two far get the down line closer to upper line by an extra vertical line
        if(tooFar)
        {
            Line up = a.getCenterY()> b.getCenterY()?line2 : line1;
            Line down = a.getCenterY()> b.getCenterY()?line1 : line2;
        ...
        circle.setStrokeWidth(2);
        circle.setFill(Color.TRANSPARENT);
        //double radiusX = ext.getEndY()/2-ext.getStartY()/2;
    ...
    {
        // Only act if user is placing a gate
        ...
        if(currentMode!=ToolMode.TOGGLE) {// secondary nodes cannot be arbitrarily toggled
    ...
    private void onConnect()
    {
        ...
        // Update bulb image dynamically
        bulbView.setImage(value ? bulbOn : bulbOff);

        // Reposition beside the node
