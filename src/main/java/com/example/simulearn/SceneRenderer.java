...
public class SceneRenderer {
    ...
    private void drawBasketballPlayer(double angleDeg) {
        ...
        gc.setFill(Color.WHITE); gc.setFont(Font.font("Arial",FontWeight.BOLD,Math.max(10,ppf*.25)));
    ...
    private void drawResultOverlay() {
        ...
        gc.setFill(resultColor); gc.setFont(Font.font("Arial",FontWeight.BOLD,52));
