...
public class PPCCController implements Initializable {
    ...
    // Prediction 1 storage: selected description index and selected reason index (-1 = none)
    private int prediction1SelectedDescription = -1;
    private int prediction1SelectedReason = -1;

    // Prediction 2 storage: order of protein bands (indices 0=Moderately hydrophobic, 1=Highly hydrophobic RFP, 2=Hydrophilic)
    ...
    private final String[][] STEP_SEQUENCES = {
            {"a", "b", "c", "d", "e", "f", "g", "h", "i"},  // Step 1: a, b, c, d, e, f, g, h, i
            {"a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n"},        // Step 2: a, b, c, d, e, f, g, h, i, j, k, l, m, n
            {"a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k"},        // Step 3: a, b, c, d
            {"a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m"},            // Step 4: a, b, c
    ...
    private VBox getContextContent() {
        ...
        whatToTitle.setFont(Font.font("Arial", FontWeight.BOLD, 18));
        ...
        whatwill.setFont(Font.font("Arial", FontWeight.BOLD, 18));
...
// Image container
        ...
        whatAre.setFont(Font.font("Arial", FontWeight.BOLD, 18));
    ...
    private VBox getPredictionsContent() {
        ...
        // ===== PREDICTION 1: RFP Culture Appearance =====
        VBox prediction1Box = createPrediction1Box();

        // ===== PREDICTION 2: Hydrophobic Column Chromatography =====
    ...
    private VBox createPrediction1Box() {
        ...
        // Two-column layout: Descriptions (left) | Reasons (right)
        HBox columnsLayout = new HBox(15);
        columnsLayout.setAlignment(Pos.TOP_LEFT);

        // === LEFT COLUMN: Descriptions (tubes) ===
        VBox descColumn = new VBox(10);
        descColumn.setPrefWidth(280);

        Label descHeader = new Label("Description");
        descHeader.setFont(Font.font("Arial", FontWeight.BOLD, 16));
        descHeader.setStyle(
                "-fx-text-fill: white;" +
        ...
        // Tube descriptions with their SVG paths
        String[][] tubeOptions = {
        ...
        for (int i = 0; i < tubeOptions.length; i++) {
            ...
            // Wrap in VBox for clean reference
        ...
        // Re-apply initial selection state
        for (int j = 0; j < tubeRows.length; j++) {
        ...
        reasonHeader.setFont(Font.font("Arial", FontWeight.BOLD, 16));
    ...
    private VBox createPrediction2Box() {
        ...
        chromoTitle.setFont(Font.font("Arial", FontWeight.BOLD, 18));
        ...
        reorderTitle.setFont(Font.font("Arial", FontWeight.BOLD, 18));
    ...
    private VBox createDraggableBandsArea() {
        ...
        // The container that holds the ordered bands
        VBox bandsContainer = new VBox(8);
        bandsContainer.setPadding(new Insets(10, 0, 10, 0));

        // Build band rows according to current stored order
    ...
    private void rebuildBands(VBox bandsContainer, String[][] bandData) {
        ...
        for (int pos = 0; pos < prediction2BandOrder.length; pos++) {
            ...
            upBtn.setFont(Font.font("Arial", 10));
            upBtn.setStyle(
            ...
            downBtn.setFont(Font.font("Arial", 10));
            downBtn.setStyle(
                    "-fx-background-color: rgba(255,255,255,0.2);" +
                            "-fx-text-fill: white;" +
                            "-fx-padding: 2 6;" +
            ...
            bandLabel.setFont(Font.font("Arial", FontWeight.BOLD, 13));
            ...
            // Up button: swap this position with the one above
            upBtn.setOnAction(e -> {
                if (position > 0) {
            ...
            // Down button: swap this position with the one below
    ...
    private VBox getMaterialsContent() {
        ...
        emptyTube.setFont(Font.font("Arial", FontWeight.BOLD, 18));
        emptyTube.setStyle("-fx-text-fill: #1a5490;");

        Label emptytubeSubtitle = new Label("Used to hold solutions");
        emptytubeSubtitle.setFont(Font.font("Arial", 14));
        ...
        otherEquipmentsTitle.setFont(Font.font("Arial", 14));
