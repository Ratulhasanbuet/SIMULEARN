...
//        switch (stericNumber) {
//            case 2:
//                return new VSEPRGeometry("Linear", 2, lonePairs, bondedAtoms, "180°",
//                        new Point3D[]{
...
//            case 3:
//                if (lonePairs == 0) {
//                    return new VSEPRGeometry("Trigonal Planar", 3, 0, 3, "120°",
//                            getTrigonalPlanar(bondLength));
//                } else if (lonePairs == 1) {
//                    return new VSEPRGeometry("Bent (120°)", 3, 1, 2, "~120°",
//                            getTrigonalPlanar(bondLength));
//                } else {
//                    return new VSEPRGeometry("Linear (from trigonal)", 3, 2, 1, "180°",
//                            getTrigonalPlanar(bondLength));
//                }
//
//            case 4:
//                if (lonePairs == 0) {
//                    return new VSEPRGeometry("Tetrahedral", 4, 0, 4, "109.5°",
//                            getTetrahedral(bondLength));
//                } else if (lonePairs == 1) {
//                    return new VSEPRGeometry("Trigonal Pyramidal", 4, 1, 3, "~107°",
//                            getTetrahedral(bondLength));
//                } else if (lonePairs == 2) {
//                    return new VSEPRGeometry("Bent (109°)", 4, 2, 2, "~104.5°",
//                            getTetrahedral(bondLength));
//                } else {
//                    return new VSEPRGeometry("Linear (from tetrahedral)", 4, 3, 1, "180°",
//                            getTetrahedral(bondLength));
//                }
//
//            case 5:
...
//
//            default:
//                return new VSEPRGeometry("Custom", stericNumber, lonePairs, bondedAtoms, "N/A",
...
//
//        if (lonePairs == 0) {
//            return new VSEPRGeometry("Trigonal Bipyramidal", 5, 0, 5, "90°, 120°, 180°", positions);
//        } else if (lonePairs == 1) {
//            return new VSEPRGeometry("Seesaw", 5, 1, 4, "~90°, ~120°", positions);
//        } else if (lonePairs == 2) {
//            return new VSEPRGeometry("T-shaped", 5, 2, 3, "~90°", positions);
//        } else {
//            return new VSEPRGeometry("Linear (from TBP)", 5, 3, 2, "180°", positions);
//        }
//    }
//
...
//
//        if (lonePairs == 0) {
//            return new VSEPRGeometry("Octahedral", 6, 0, 6, "90°, 180°", positions);
//        } else if (lonePairs == 1) {
//            return new VSEPRGeometry("Square Pyramidal", 6, 1, 5, "~90°", positions);
//        } else {
//            return new VSEPRGeometry("Square Planar", 6, 2, 4, "90°, 180°", positions);
//        }
//    }
//
